    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", y = "layui-anim layui-anim-upbit", f = {
            tabClick: function (i, t, s) {
                var o = s || a(this), t = t || o.index(), c = o.parents(".layui-tab").eq(0),
...
layui.define("layer", function (e) {
    ...
    var i = layui.jquery, t = layui.layer, a = layui.hint(), n = layui.device(), l = "form", r = ".layui-form",
        s = "layui-this", c = "layui-hide", o = "layui-disabled", u = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
            ...
            select: function () {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", u = "layui-select-none", d = "",
                    f = i(r).find("select"), y = function (t, l) {
                        ...
                        var v = i(this), h = t.find("." + n), m = h.find("input"), p = t.find("dl"), k = p.children("dd");
                        if (!r) {
                            var x = function () {
                                t.addClass(a + "ed"), k.removeClass(c)
                            }, b = function () {
                                t.removeClass(a + "ed"), m.blur(), g(m.val(), function (e) {
                                    e && (d = p.find("." + s).html(), m && m.val(d))
                                })
                            };
                            h.on("click", function (e) {
                                t.hasClass(a + "ed") ? b() : (y(e, !0), x()), p.find("." + u).remove()
                            ...
                            var g = function (e, t, a) {
                                ...
                                layui.each(k, function () {
                                    ...
                                    ("" === e || (a ? r : e !== l)) && n++, a && t[r ? "addClass" : "removeClass"](c)
                                });
                                var l = n === k.length;
                                return t(l), l
                            }, C = function (e) {
                                var i = this.value, t = e.keyCode;
                                return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && void g(i, function (e) {
                                    e ? p.find("." + u)[0] || p.append('<p class="' + u + '">无匹配项</p>') : p.find("." + u).remove()
                                }, !0)
                            };
                            f && m.on("keyup", C).on("blur", function (i) {
                                e = m, d = p.find("." + s).html(), d || m.val("")
                            }), k.on("click", function () {
                                var e = i(this), a = e.attr("lay-value"), n = v.attr("lay-filter");
                                return !e.hasClass(o) && (v.val(a).removeClass("layui-form-danger"), m.val(e.text()), e.addClass(s).siblings().removeClass(s), layui.event.call(this, l, "select(" + n + ")", {
                                    elem: v[0],
                                    value: a,
                                    othis: t
                                }), b(), !1)
                ...
                f.each(function (e, l) {
                    var r = i(this), c = r.next("." + a), u = this.disabled, d = l.value,
                    ...
                    var y = "string" == typeof r.attr("lay-search"),
                        h = i(['<div class="layui-unselect ' + a + (u ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + (l.options[0].innerHTML ? l.options[0].innerHTML : t) + '" value="' + (d ? f.html() : "") + '" ' + (y ? "" : "readonly") + ' class="layui-input layui-unselect' + (u ? " " + o : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group" : "") + '">' + function (e) {
                            ...
                            return layui.each(e, function (e, t) {
                                (0 !== e || t.value) && ("optgroup" === t.tagName.toLowerCase() ? i.push("<dt>" + t.label + "</dt>") : i.push('<dd lay-value="' + t.value + '" class="' + (d === t.value ? s : "") + (t.disabled ? " " + o : "") + '">' + t.innerHTML + "</dd>"))
                            }), i.join("")
                        }(r.find("*")) + "</dl>", "</div>"].join(""));
                    c[0] && c.remove(), r.after(h), v.call(this, h, u, y)
                })
            }, checkbox: function () {
                var e = {
                ...
                t.each(function (t, n) {
                    ...
                    var d = l.next("." + u[0]),
                        f = i(['<div class="layui-unselect ' + u[0] + (n.checked ? " " + u[1] : "") + (c ? " layui-checkbox-disbaled " + o : "") + '" lay-skin="' + (r || "") + '">', {_switch: "<em>" + ((n.checked ? s[0] : s[1]) || "") + "</em><i></i>"}[r] || "<span>" + (n.title || "勾选") + '</span><i class="layui-icon">' + (r ? "&#xe605;" : "&#xe618;") + "</i>", "</div>"].join(""));
                ...
                var e = "layui-form-radio", t = ["&#xe643;", "&#xe63f;"], a = i(r).find("input[type=radio]"),
                    n = function (a) {
                        ...
                        a.on("click", function () {
                            var c = n[0].name, o = n.parents(r), u = n.attr("lay-filter"),
                ...
                a.each(function (a, l) {
                    var r = i(this), s = r.next("." + e), c = this.disabled;
                    if ("string" == typeof r.attr("lay-ignore")) return r.show();
    ...
    var d = function () {
        var e = i(this), a = f.config.verify, s = null, c = "layui-form-danger", o = {}, u = e.parents(r),
            d = u.find("*[lay-verify]"), y = e.parents("form")[0], v = u.find("input,select,textarea"),
            h = e.attr("lay-filter");
        return layui.each(d, function (e, l) {
            var r = i(this), o = r.attr("lay-verify").split("|"), u = "", d = r.val();
    ...
    var c = function (t, i, a) {
        ...
        var a = function () {
            ...
            return layui.each(t, function (t, i) {
                e[i] = layui.cache.dir + "img/face/" + t + ".gif"
            }), e
        }();
